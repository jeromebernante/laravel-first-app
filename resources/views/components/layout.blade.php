...
<body class="min-h-screen flex flex-col
    ...
    <nav class="navbar bg-base-100 [box-shadow:0_-2px_8px_0_rgba(0,0,0,0.08)]">
    ...
    <footer class="w-full mt-24 bg-base-100 [box-shadow:0_-2px_8px_0_rgba(0,0,0,0.08)]">
        <div class="mx-auto w-full max-w-[1400px] px-4 xl:px-16 py-6 text-center text-sm text-gray-600">
            This app was built by following the
            <a href="https://laravel.com/learn/getting-started-with-laravel" target="_blank" class="text-blue-500 hover:underline">
                Getting Started with Laravel
            </a>
            — a guide for starter developers. <br>
            Followed & Created by <span class="font-semibold">Jerome</span>.
        </div>
    </footer>
